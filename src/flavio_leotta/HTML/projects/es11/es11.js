...
function aggiungiParagrafo() {
  ...
  var testo = document.createTextNode('Questo è un nuovo paragrafo aggiunto prima del secondo paragrafo esistente.');
  nuovoParagrafo.appendChild(testo);

  // Troviamo l'elemento paragrafo esistente che vogliamo precedere
  var paragrafoDaSostituire = document.getElementById('paragrafo_da_sostituire');
