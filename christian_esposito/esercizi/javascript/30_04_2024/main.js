...
btnColor.addEventListener("click", function redT (){text1.style.color = "red"})
// EXERCISES 2

const cube = document.getElementById("ex2")
const btnHidden = document.getElementById("btn_hidden")

btnHidden.addEventListener("click", function cubeHidden(){ cube.style.display = "none"})
...
btnEx4.addEventListener("click",function(){ex4Text.innerHTML = "Facciamo l'esercizio 5"})

// EXERCISES 5

const ex5 = document.getElementById("ex5")
const btn5 = document.getElementById("btn_ex5")
btn5.addEventListener("click", function(){ex5.classList.add("class_add")})

// EXERCISES 6

const btnEx6 = document.getElementById("btn_ex6")
btnEx6.addEventListener("click", function(){text1.remove()})
...
btnEx7.addEventListener("click", function() {
    sostituzioneElement(textEx7, "<button>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident cupiditate voluptatibus sint perferendis ipsum,a iste veritatis iusto adipisci non dignissimos quod quia repudiandae optio excepturi soluta corrupti.Error, iste?</div>")
})
...
const newElementEx15 = () => {
    ...
    setTimeout(()=>{elEx15.insertBefore(newP, addElementEx15)},5000)
